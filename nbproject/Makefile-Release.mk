...
${OBJECTDIR}/bisection.o: bisection.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/bisection.o bisection.cpp

${OBJECTDIR}/functions01.o: functions01.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/functions01.o functions01.cpp

${OBJECTDIR}/functions02.o: functions02.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/functions02.o functions02.cpp
...
${OBJECTDIR}/hw03_ebb2_main.o: hw03_ebb2_main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/hw03_ebb2_main.o hw03_ebb2_main.cpp
