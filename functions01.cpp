...
double findA(double x, double E, double *params) {
    ...
    double m = params[1];
    double v_0 = params[2];
    double alpha1 = alpha(m, E);
    double beta1 = beta(m, v_0, E);
    return 2;
}
...
double wavefunction_01d(double x, double A, double B, double alpha, double beta) {
    return alpha * (A * cos(alpha * x) - B * sin(alpha * x));
}

double wavefunction_01a(double x, double A, double B, double alpha, double beta) {
